...
namespace Simple.Testing.Framework
{
	...
	public class EventSpecification<TCommand> : TypedSpecification<TCommand>
	{
		public Action Before;
		public Func<TCommand> On;
		public WhenAction<TCommand> When;
		public List<Expression<Func<TCommand, bool>>> Expect = new List<Expression<Func<TCommand, bool>>>();
		public Action Finally;
		public string Name;
		...
		public Delegate GetOn() { return On; }
		public Delegate GetWhen() { return When; }
		public IEnumerable<Expression<Func<TCommand, bool>>> GetAssertions() { return Expect; }
		public Action GetFinally() { return Finally; }
		public string GetName() { return Name; }
	}
